...
export class CreateMenuDto {
	...
	@ApiPropertyOptional({ description: "编码，操作类型必须填写", maxLength: 100 })
	@IsOptional()
	...
	@ApiPropertyOptional({ description: "路由名称，菜单类型建议填写", maxLength: 100 })
	@IsOptional()
	@IsString({ message: "路由名称必须是字符串" })
	@Length(1, 100, { message: "路由名称长度必须在 1 到 100 个字符之间" })
	routeName?: string | null;

	@ApiPropertyOptional({ description: "路由路径，菜单类型必须填写", maxLength: 255 })
	@ValidateIf((dto, value) => dto.type === MenuType.MENU || (value !== undefined && value !== null))
	@IsString({ message: "路由路径必须是字符串" })
	@Length(1, 255, { message: "路由路径长度必须在 1 到 255 个字符之间" })
	path?: string | null;

	@ApiPropertyOptional({ description: "页面组件，菜单类型必须填写", maxLength: 255 })
	@ValidateIf((dto, value) => dto.type === MenuType.MENU || (value !== undefined && value !== null))
	@IsString({ message: "页面组件必须是字符串" })
	@Length(1, 255, { message: "页面组件长度必须在 1 到 255 个字符之间" })
	component?: string | null;

	@ApiPropertyOptional({ description: "重定向地址，目录或菜单类型可填写", maxLength: 255 })
	@IsOptional()
	@IsString({ message: "重定向地址必须是字符串" })
	@Length(1, 255, { message: "重定向地址长度必须在 1 到 255 个字符之间" })
	redirect?: string | null;

	@ApiPropertyOptional({ description: "图标，目录或菜单类型可填写", maxLength: 100 })
	@IsOptional()
	...
	@ApiPropertyOptional({ description: "是否缓存页面，仅菜单类型可填写", default: false })
	@IsOptional()
